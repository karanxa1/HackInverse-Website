...
const SponsorsSection = () => {
  ...
  return (
    ...
    >
      <div 
        className="flex justify-center items-center w-full max-w-[600px] mx-auto mb-[3vh]" 
        data-aos="fade-in" 
      ...
      <div className="flex flex-col gap-[3vh] justify-center items-center max-w-[1400px] mx-auto max-[992px]:gap-[2.5vh] max-[768px]:gap-[2vh] max-[576px]:gap-[1.5vh]">
